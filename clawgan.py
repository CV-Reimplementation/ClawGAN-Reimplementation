...
parser.add_argument("--dataset_name", type=str, default="IR-VIS", help="name of the dataset")
...
parser.add_argument("--n_residual_blocks", type=int, default=32, help="number of residual blocks in generator")
